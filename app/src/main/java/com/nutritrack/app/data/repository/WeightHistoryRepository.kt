...
interface WeightHistoryRepository {
    ...
    fun observeEntriesBetweenDates(startDate: LocalDate, endDate: LocalDate): Flow<List<WeightEntryEntity>>
...
class RoomWeightHistoryRepository @Inject constructor(
    ...
    override fun observeEntriesBetweenDates(startDate: LocalDate, endDate: LocalDate): Flow<List<WeightEntryEntity>> =
